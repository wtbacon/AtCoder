...
int main() {
    ...
    int foundB1 = S.find('B');
    int foundB2 = S.find('B', foundB1 + 1);
    if ((foundB2 - foundB1) % 2 == 0) {
        cout << "No" << endl;
        return 0;
    }

    int foundK = S.find('K');
    int foundR1 = S.find('R');
    int foundR2 = S.find('R', foundR1 + 1);
    if (foundR1 < foundK && foundK < foundR2) {
        cout << "Yes" << endl;
    } else cout << "No" << endl;
    return 0;
}